...
public class InRoomChat : Photon.MonoBehaviour
{
	...
	public void OnGUI()
	{
		...
		{
			var ColorGUI = new GUIStyle();
			if(color [i] == "white"){
				ColorGUI.normal.textColor = Color.black;
				ColorGUI.fontSize = 12;
			}
			if(color [i] == "green"){
				ColorGUI.normal.textColor = Color.red;
				ColorGUI.fontSize = 15;
			}
			GUILayout.Label(messages[i], ColorGUI);
		}
